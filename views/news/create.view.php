...
<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <textarea id="content" name="content" rows="3" placeholder="Content" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"></textarea>
          </div>
        </div>
        ...
        <form action="/add" id="image" name="image" method="post" enctype="multipart/form-data">
